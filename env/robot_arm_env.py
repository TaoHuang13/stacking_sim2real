...
class ArmPickAndPlace(ArmGoalEnv):
    ...
    def _sample_goal(self):
        ...
        self._waypoints[0] = np.array([pos_obj[0], pos_obj[1], pos_obj[2] + 0.05, 0.5])
        self._waypoints[1] = np.array([pos_obj[0], pos_obj[1], pos_obj[2], 0.5])
        self._waypoints[2] = np.array([pos_obj[0], pos_obj[1], pos_obj[2], 0])
        self._waypoints[3] = np.array([goal[0], goal[1], goal[2], 0])
